 ...
 def upsert_signals(self,df):
  ...
  with self._conn() as con:
   for _,r in df.iterrows():
    ...
    vals[cols.index('qualification_version')] = safe_text(r.get('qualification_version','3.6.2')) or '3.6.2'
